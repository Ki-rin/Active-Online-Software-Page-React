...
const Dgen = (props) => {
  return (
    <div className="dgen-container">
      <Helmet>
        <title>Active Online Software Page</title>
        <meta property="og:title" content="Active Online Software Page" />
      </Helmet>
      <section className="dgen-features">
        <span className="dgen-text">
          <span>D-Gen -</span>
          <span>Your MRM validation co-pilot</span>
        </span>
        <div className="dgen-title"></div>
        <div className="dgen-banner card">
          <span className="dgen-text03">Enter your question here</span>
          <div className="dgen-output card">
            <span className="dgen-text04">Input</span>
            <span className="dgen-text05 textarea">
            ...
            <input
              ...
              className="dgen-uploadfiles input textarea"
            />
            <input
              type="text"
              placeholder="Upload your code here"
              className="dgen-uploadfiles1 input textarea"
            />
            <button type="submit" className="dgen-button button">
              Generate
            </button>
          </div>
          <div className="dgen-container1"></div>
          <header data-role="Header" className="dgen-generate-button">
            <div className="dgen-nav"></div>
            <div className="dgen-icon-group"></div>
            <div className="dgen-container2">
              <div className="dgen-container3"></div>
            </div>
            <div data-role="BurgerMenu" className="dgen-burger-menu">
              <svg viewBox="0 0 1024 1024" className="dgen-icon">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>
            </div>
            <div data-role="MobileMenu" className="dgen-mobile-menu">
              <div className="dgen-nav1">
                <div className="dgen-container4">
                  <img
                    alt="image"
                    src="https://presentation-website-assets.teleporthq.io/logos/logo.png"
                    className="dgen-image"
                  />
                  <div
                    data-role="CloseMobileMenu"
                    className="dgen-close-mobile-menu"
                  >
                    <svg viewBox="0 0 1024 1024" className="dgen-icon02">
          ...
          <span className="dgen-text16">Results Displayed here</span>
          <div className="dgen-output1 card">
            <span className="dgen-text17">Output</span>
            <span className="dgen-text18 textarea">
              <span className="Content dgen-text19">
              ...
              <br className="dgen-text21"></br>
              <span className="Content dgen-text22">
